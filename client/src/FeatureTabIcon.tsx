...
export const SignOutIcon = () => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="ml-1 h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-yellow-500 dark:text-[#f8f4eb] dark:group-hover:text-yellow-300"
    >
